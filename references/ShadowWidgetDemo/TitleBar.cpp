...
void TitleBar::TitleBarUi::setupUi(QWidget* titleBar) {
    ...
    titleBar->connect(btnMinimize, &QPushButton::clicked, titleBar, [=] { titleBar->showMinimized(); });
    ...
    titleBar->connect(btnMaximize, &QPushButton::clicked, titleBar, [=] { titleBar->showMaximized(); });
    ...
    btnRestore->setStyleSheet(QString::fromUtf8("QPushButton{\n"
                                                "	border:0px;\n"
                                                "	border-radius:3px;\n"
                                                "	background:transparent;\n"
                                                "}\n"
    ...
    btnClose->setStyleSheet(QString::fromUtf8("QPushButton{\n"
                                              ...
                                              "}\n"
                                              "QPushButton:hover {\n"
                                              "	background:rgb(254,83,56);\n"
                                              "}\n"
                                              "QPushButton:click{\n"
                                              "	background:rgb(223,73,50);\n"
                                              "}"));
    QIcon icon3;
...
TitleBar::TitleBar(QWidget* parentWidget, TitleButtons button, QWidget* parent) : QWidget(parent), flag(button), parentWidget(parentWidget) {
    ui.setupUi(this);
